...
#define STRING_CONFIG_H_AUTHOR "The 300lb Gorilla" // Who made the changes.    CHANGE DATE 12-27-2022  Firmware Version 4.2.3
//#define CUSTOM_VERSION_FILE Version.h 

#define SHOW_BOOTSCREEN

#define SHOW_CUSTOM_BOOTSCREEN           //<------------------------------------------------------------------------------------------------ GTPG-LLC v4.2.3 Enabled

//#define CUSTOM_STATUS_SCREEN_IMAGE    //<--------------(Disabled to Clean Up Main Status Screen)----------------------------------------  GTPG-LLC v4.2.3 Disabled
...
// Define Main Control Board (Creality 4.2.3)<------------------------------------------------------------------------------------------------------ GTPG-LLC v4.2.3
// default_envs = STM32F103RET6_creality (From Platformio.ini File)<---------------------------------------------- Stock Ender 2 Pro OEM BOARD 4.2.3 GTPG-LLC v4.2.3

#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CREALITY_V4  //<------------------------------------------Only For CPU Type: STM32F103RET6 (For older Creality v4.2.3 Ender 2 Pro Motherboards)
#endif                                                                              //This will NOT work on Mainboard version 2.4.s4

#define CUSTOM_MACHINE_NAME "Ender 2 Pro v4.2.3"     //<-----(Removed "-" Between Ender and 2)------------------------------------------------------------- GTPG-LLC v4.2.3
...
//#define SINGLENOZZLE  //<----(No need to change because the Ender 2 Pro comes by default with only 1 nozzle)-----------------------------------------GTPG-LLC v4.2.3
...
#define BED_MAXTEMP       90 //<------------------ (Reduced from 100c) ----------------------------------------------------------------------------- GTPG-LLC v4.2.3
#define PIDTEMP
#define BANG_MAX 255     
...
//#define BED_LIMIT_SWITCHING   //<-------------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Disabled
...
#define EXTRUDE_MINTEMP 170         //<-------------------------- (Changed from 180c to 170c) ------------------------------------------------------ GTPG-LLC v4.2.3 

#define PREVENT_LENGTHY_EXTRUDE
#define EXTRUDE_MAXLENGTH 500       //<----------------- (Longer Feed) ----------------------------------------------------------------------------- GTPG-LLC v4.2.3 

#define THERMAL_PROTECTION_HOTENDS   // Enable thermal protection for all extruders
#define THERMAL_PROTECTION_BED       // Enable thermal protection for the heated bed
//#define THERMAL_PROTECTION_CHAMBER //<---------------- (No Chamber On An Ender 2 Pro) --------------------------------------------------- GTPG-LLC v4.2.3 Disabled 
...
#define X_DRIVER_TYPE TMC2208_STANDALONE //<---------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Confirmed
#define Y_DRIVER_TYPE TMC2208_STANDALONE //<---------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Confirmed
#define Z_DRIVER_TYPE A4988              //<---------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Confirmed
//#define X2_DRIVER_TYPE A4988           
//#define Y2_DRIVER_TYPE A4988
//#define Z2_DRIVER_TYPE A4988
//#define Z3_DRIVER_TYPE A4988
//#define Z4_DRIVER_TYPE A4988
#define E0_DRIVER_TYPE A4988             //<---------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Confirmed
...
//#define DETECT_BROKEN_ENDSTOP         //<------------------------------------------------------------------------------------------------ GTPG-LLC v4.2.3 Disabled
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 92.6 }       //<-------------------- GTPG-LLC v4.2.3 Set to 92.6 for Stock Regular Extruder
// Uncomment 143.5 E-Steps for Dual Gear Extruder (Line 371), and Comment out "//" (Line 369)
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 143.5 }        //<-------------------- GTPGllc v3.1.5 Set to 143.5 for Dual Gear Extruder
//***************************************************************************************************************************************************************
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 25 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2 //<----------------------------------------- GTPG-LLC v4.2.3 Enabled
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 10, 50 }
#endif

#define DEFAULT_MAX_ACCELERATION      { 300, 300, 100, 1000 }     //<------------------------------------------------------------- GTPG-LLC v4.2.3 Changed - Doubled

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2 //<------------------------------------- GTPG-LLC v4.2.3 Enabled
...
#define CLASSIC_JERK     //<---------------------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Enabled
#if ENABLED(CLASSIC_JERK)
  #define DEFAULT_XJERK 6.0
  #define DEFAULT_YJERK 6.0
  #define DEFAULT_ZJERK  0.4
//#define TRAVEL_EXTRA_XYJERK 0.0
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2 <-------------------------------------------------- GTPG-LLC v4.2.3 Enabled
...
#define S_CURVE_ACCELERATION     //<-------------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Enabled
 ...
 * You wil need to configure the firmware manually for the BL-Touch if you want use all the features added to GTPGllc v3.1.5 Firmware
 ...
 * You wil need to configure the firmware manually for the CR-Touch if you want use all the features added to GTPGllc v3.1.5 Firmware
...
#endif
//#define PROBING_HEATERS_OFF    //<------------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Disabled
#if ENABLED(PROBING_HEATERS_OFF)
  //#define WAIT_FOR_BED_HEATER     
#endif
//#define PROBING_FANS_OFF      // Turn fans off when probing <---------------------------------------------------------------------------- GTPG-LLC v4.2.3 Disabled
...
#define X_BED_SIZE 165     //<--------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Set To Actual Size
#define Y_BED_SIZE 165     //<--------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Set To Actual Size

//**********************************************************************************************************************************************************************
//                                                      FOR DUAL PARTS COOLING FAN SETUP
// Travel limits (mm) after homing, corresponding to endstop positions.
//#define X_MIN_POS -11     //<------------------(Designed for Dual Parts Fan Bracket) ----------------------------------------- GTPG-LLC v4.2.3 Set To Actual Size
...
#define Y_MIN_POS -4     //<----------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Set To Actual Size
#define Z_MIN_POS 0      //<----------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Set To Actual Size
...
//**********************************************************************************************************************************************************************
//#define Z_MAX_POS 210  //<-------------------(Only if you use spacers on the Lead Screw Coupler & And replace top Red Handle with the parts below)-- GTPG-LLC v4.2.3
...
#define MIN_SOFTWARE_ENDSTOPS  //<---------------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Enabled
...
#define MAX_SOFTWARE_ENDSTOPS   //<--------------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Enabled
...
#define FILAMENT_RUNOUT_SENSOR     //<------------------------------------------------------------------------------------------------------ GTPG-LLC v4.2.3 Enabled
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define NUM_RUNOUT_SENSORS   1     
  #define FIL_RUNOUT_STATE     LOW  // Pin state indicating that filament is NOT present.<------------(Set to LOW for Creality Brand FRS)----------- GTPG-LLC v4.2.3 
...
#define MESH_BED_LEVELING    //<------------------------------------------------------------------------------------------------------------ GTPG-LLC v4.2.3 Enabled
//#define RESTORE_LEVELING_AFTER_G28
#define DEBUG_LEVELING_FEATURE    //<------------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Enabled
  ...
  #define MESH_INSET 20          // Set Mesh bounds as an inset region of the bed    //<---------------------------------- GTPG-LLC v4.2.3 Changed From 10mm to 20mm
  #define GRID_MAX_POINTS_X 3    // Don't not change for the Ender 2 Pro. Throws a "Outside of Printable Area ERROR"     //<------------------------ GTPG-LLC v4.2.3
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define LCD_BED_LEVELING  //<--------------(Needed for LCD Manual MESH BED LEVELING and 4 CORNER LCD ASSISTED BED LEVELING)----------------- GTPG-LLC v4.2.3 Enabled
...
#define LEVEL_BED_CORNERS  //<------(LCD ASSITED 4 CORNER BED LEVELING)---------------- GTPG-LLC v4.2.3 Enabled for Adjusting Height with Bed Height Ajusting Wheels
...
#define SKEW_CORRECTION   //<--------- GTPG-LLC v4.2.3 Enabled
  ...
  #define XY_SKEW_FACTOR 0.0   //<--------------------(DO NOT CHANGE)------------------------------------------------------------------------------- GTPG-LLC v4.2.3
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define YZ_SIDE_AD 165 //<--------------------------Changed for New Version of Firmware, now Ender 2 Pro-v4.2.3 (The 300lb Gorilla) Changed, Correct Measurement for Ender 2 Pro
...
// Preheat Constants                 //<------------------------------------------------------------------------------------------------------------ GTPG-LLC v4.2.3
                                     //<------------------------------------------------------------------Changed Pre Heat from 200c/55c to 210c/65c GTPG-LLC v4.2.3
#define PREHEAT_1_LABEL       "PLA"  //<------------------------------------------------------------------------------------------------------------ GTPG-LLC v4.2.3
#define PREHEAT_1_TEMP_HOTEND 210    //<------------------------------------------------------------------------------------------------------------ GTPG-LLC v4.2.3
#define PREHEAT_1_TEMP_BED     65    //<------------------------------------------------------------------------------------------------------------ GTPG-LLC v4.2.3 
#define PREHEAT_1_FAN_SPEED   255 // Value from 0 to 255
// Since the Ender 2 Pro has a LIMITED BED HEAT of 90c, ABS is pretty much a non starter<------------------------------------------------------------GTPG-LLC v4.2.3

// ABS Preheat Settings have been Removed <--------------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3
...
//#define PRINTCOUNTER    //<-----------(Removed due to Maintenance Reminders)------------------------------------------------------------- GTPG-LLC v4.2.3 Disabled
...
#define INDIVIDUAL_AXIS_HOMING_MENU   //<--------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Enabled

#define SPEAKER //<------------------------------------------------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Enabled

#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2  //<------------------------------------------------------------------------------- GTPG-LLC v4.2.3 Changed from 5 to 2
#define LCD_FEEDBACK_FREQUENCY_HZ 1000       //<---------------------------------------------------------------------- GTPG-LLC v4.2.3 Changed from 5000hz to 1000hz
...
#define CR10_STOCKDISPLAY    //<------------------------------------------------------------------------ GTPG-LLC v4.2.3 This is the correct Display for Ender 2 Pro
...
#define RET6_12864_LCD  //<---Leave this alone! Your Stock CR10_STOCKDISPLAY is a RET6 128x64 LCD  <------------------------------------------------ GTPG-LLC v4.2.3
