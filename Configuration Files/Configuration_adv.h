 ...
 * File Name: Configuration_adv.h
 * File Directory: Marlin\Configuration_adv.h
 * 
...
//**************************************************WARNING: LOTS OF LONG WINDED EXPLANATIONS BELOW****************************************************************
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LCD_INFO_MENU    //<------------------------------------------------- ***** GORILLA-TECH-v3.1.5 ***** Enabled (Custom)
...
//#define STATUS_MESSAGE_SCROLLING  //<------------------------------------------------- ***** GORILLA-TECH-v3.1.5 ***** Disabled
...
#define LCD_TIMEOUT_TO_STATUS 5000000  //<--------------Prevents System From Returning To Main Screen To Quickly----- ***** GORILLA-TECH-v3.1.5 *****

// Add an 'M73' G-code to set the current percentage
//#define LCD_SET_PROGRESS_MANUALLY

// Show the E position (filament used) during printing
//#define LCD_SHOW_E_TOTAL  //<------------------------------------------------- ***** GORILLA-TECH-v3.1.5 ***** Disabled
  ...
  /**
   * Continue after Power-Loss (Creality3D) //<------------------------------------------------- ***** GORILLA-TECH-v3.1.5 ***** Disabled
   *
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY  //<------------------------------------------------- ***** GORILLA-TECH-v3.1.5 ***** Disabled
   ...
   */
  #define SDCARD_SORT_ALPHA //<----------------------------------------------------------- ***** GORILLA-TECH-v3.1.5 ***** Enabled

  // SD Card Sorting options
  #if ENABLED(SDCARD_SORT_ALPHA) //<------------------------------------------------- ***** GORILLA-TECH-v3.1.5 ***** Enabled (Folder on Bottom)
  ...
  //#define LONG_FILENAME_HOST_SUPPORT  //<------------------------------------------------- ***** GORILLA-TECH-v3.1.5 ***** disabled

  // Enable this option to scroll long filenames in the SD card menu
  #define SCROLL_LONG_FILENAMES  //<--------------------------------------------------------- ***** GORILLA-TECH-v3.1.5 ***** enabled
